...
async function main() {
  ...
  console.log("Deploying Updated VoidFacet with account:", deployer.address);
  ...
  // 2. Cut Diamond (Replace)
  console.log("2. Cutting Diamond (Replacing)...");
